...
Go_Chatting.prototype = {
    init: function() { // 初始化程序
        ...
        this.socket.on('connect', function() {
            //连接到server成功后，显示登录框
            document.getElementById('info').textContent = "Set Your Username:";
            document.getElementById('nickWrapper').style.display = "block";
            document.getElementById('nicknameInput').focus(); //该对象获得焦点
        });
        //显示昵称被占用
        this.socket.on('nickExisted', function() {
            document.getElementById("info").textContent = "This username is already taken, please choose another one."
        });
        this.socket.on('loginSuccess', function() {
            document.title = "Heuko | " + document.getElementById("nicknameInput").value;
